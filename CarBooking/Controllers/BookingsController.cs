...
namespace CarBooking.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingID,CarID,UserName,BookingDate,BookingAmount,Status")] Booking booking)
        {
            ...
            ViewBag.UserName = new SelectList(db.CustomerDetails, "UserName", "FirstName", booking.UserName);
            return View(booking);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingID,CarID,UserName,BookingDate,BookingAmount,Status")] Booking booking)
        {
            if (ModelState.IsValid)
            {
